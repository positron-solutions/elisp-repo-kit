...
- [ ] Set up your git commit signing *and* [[#sign-off][sign-off]] so that it will
  be straightforward[fn:1] for for FSF to pull in your changes if they want to
  later
...
[fn:1] Free Software Foundation currently requires copyright assignment on all
